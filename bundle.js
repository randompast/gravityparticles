...
var EmitterRing = function EmitterRing(r, n, count) {
    var emitters = [];
    for (var i = 0; i < n; i++) {
...
},{"./ParticleEmitter.js":3}],3:[function(require,module,exports){
'use strict';

var particleUpdate = require('./particleUpdate.js');

var randV = function randV(s) {
	return [(Math.random() - 0.5) * s, (Math.random() - 0.5) * s];
};

var ParticleEmitter = function ParticleEmitter(p, count) {
	var _this = this;

	this.pos = p;
	this.alive = true;
	// this.particles = Array.from(Array(count).keys()).map( i => (new Particle(this.pos, randV(this.speed), i)) )
	this.particles = Array.from(Array(count).keys()).map(function (i) {
		return { pos: _this.pos, vel: randV(_this.speed), age: i };
	});
};
...
ParticleEmitter.prototype.update = function (ctx, dt, planets, image) {
	...
	if (planets.length > 0 && this.alive) {
		this.particles = this.particles.map(function (i) {
			return particleUpdate(_this2.pos, i, dt, planets);
		});
		this.particles.forEach(function (i) {
			return ctx.drawImage(image, i.pos[0] - size / 2, i.pos[1] - size / 2, size, size);
		});
...
},{"./particleUpdate.js":22}],4:[function(require,module,exports){
'use strict';
...
var Player = function Player(p, v) {
    this.pos = p;
    this.v = v;
    this.score = 0;
    this.angle = Math.PI;
...
Player.prototype.update = function (canvas, ctx, dt, planets) {
    ...
    var collide = planets.map(function (i) {
        return collisionPlanet(_this.pos, i);
    }).some(function (i) {
        return i;
    });
...
},{"./ParticleEmitter.js":3,"./collisionPlanet.js":6,"./gravitation.js":9}],5:[function(require,module,exports){
"use strict";

var img = require('./img.js');
module.exports = { "earth": img(0),
  "greenParticle": img(1),
  "spaceFlorida": img(2) };

},{"./img.js":12}],6:[function(require,module,exports){
"use strict";
...
module.exports = function (p, v, dt, planets) {
	var a = planets.map(function (i) {
		return gravityAcc(p, dt, i);
	}).reduce(function (a, b) {
...
},{"./gravitationalAcceleration.js":10}],10:[function(require,module,exports){
"use strict";

module.exports = function (p, dt, planet) {
    //d multithreading issues
    var rx = p[0] - planet.x;
    var ry = p[1] - planet.y;
    var r = Math.sqrt(rx * rx + ry * ry);
...
module.exports = ["art/Earth2.png" //Bagsby
...
},{"./img-src.js":11}],13:[function(require,module,exports){
"use strict";

var drawImg = require('./drawImg.js');
var EmitterRing = require("./EmitterRing.js");

var planets = [{ x: 0, y: 0, s: 300, m: 500, r: 100, artprop: "earth" }, { x: -400, y: 0, s: 60, m: 100, r: 100, artprop: "earth" }];
...
var renderPlaying = function renderPlaying(g, dt) {
  planets.forEach(function (i) {
    return drawImg(g.ctx, [i.x, i.y], i.s, g.art[i.artprop]);
  });
  level.emitters.forEach(function (i) {
    return i.update(g.ctx, dt, planets, g.art["greenParticle"]);
  });
...
},{"./EmitterRing.js":2,"./drawImg.js":7}],14:[function(require,module,exports){
...
},{"element-size":15}],15:[function(require,module,exports){
...
},{"./lib/key-combo":18,"./lib/keyboard":19,"./lib/locale":20,"./locales/us":21}],18:[function(require,module,exports){
...
},{"./key-combo":18,"./locale":20}],20:[function(require,module,exports){
...
},{"./key-combo":18}],21:[function(require,module,exports){
...
},{"./collisionPlanet.js":6,"./gravitation.js":9}],23:[function(require,module,exports){
"use strict";

module.exports = function (canvas) {
  // console.log("Making stars") //width*height/10000, sparse enough
  return Array.from(Array(Math.floor(canvas.width * canvas.height / 10000)).keys()).map(function (i) {
...
game.stars.forEach(function (i) {
  return starsDraw(ctx, i);
});
...
},{"./Player.js":4,"./art.js":5,"./endscreen.js":8,"./level0.js":13,"./stars.js":23,"./starsDraw.js":24,"./title.js":25,"canvas-fit":14,"es6-shim":16,"keyboardjs":17}]},{},[26]);
